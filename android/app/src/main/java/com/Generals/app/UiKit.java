...
final class UiKit {
    ...
    static LinearLayout scrollingPage(ViewGroup host) {
        ...
        int gutter = dim(c, R.dimen.gen_gutter);
        column.setPadding(gutter, dp(c, 4), gutter, dim(c, R.dimen.gen_card_gap));
    ...
    static TextView appBar(ViewGroup parent, CharSequence overline, CharSequence title,
        ...
        if (overline != null) {
            ...
            over.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_overline));
            over.setTextColor(color(c, R.color.gen_on_surface_faint));
        ...
        titleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_display));
        titleView.setTextColor(color(c, R.color.gen_on_surface));
    ...
    static View iconButton(Context c, int iconRes, CharSequence description, Runnable action) {
        int size = dim(c, R.dimen.gen_icon_button);
        ImageView button = new ImageView(c);
        button.setImageDrawable(ContextCompat.getDrawable(c, iconRes));
        button.setImageTintList(tint(c, R.color.gen_on_surface_variant));
        ...
        bg.setColor(color(c, R.color.gen_surface_container_high));
        button.setBackground(bg);
        button.setClickable(true);
        button.setFocusable(true);
        button.setOnClickListener(v -> action.run());
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(size, size);
        lp.setMarginStart(dim(c, R.dimen.gen_item_gap));
    ...
    static LinearLayout card(LinearLayout parent) {
        ...
        card.setRadius(dim(c, R.dimen.gen_radius_card));
        card.setCardElevation(0f);
        card.setCardBackgroundColor(color(c, R.color.gen_surface_container));
        ...
        int pad = dim(c, R.dimen.gen_card_padding);
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.topMargin = dim(c, R.dimen.gen_card_gap);
    ...
    static TextView sectionHeader(LinearLayout body, int iconRes, CharSequence title, boolean withValue) {
        ...
        if (iconRes != 0) {
            ...
            icon.setImageTintList(tint(c, R.color.gen_primary));
            int s = dim(c, R.dimen.gen_icon);
        ...
        TextView titleView = new TextView(c);
        titleView.setText(title);
        titleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_title));
        titleView.setTextColor(color(c, R.color.gen_on_surface));
        titleView.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        if (withValue) {
            ...
            value.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_title));
            value.setTextColor(color(c, R.color.gen_primary));
            value.setTypeface(Typeface.DEFAULT_BOLD);
            value.setGravity(Gravity.END);
            LinearLayout.LayoutParams vlp = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            vlp.setMarginStart(dim(c, R.dimen.gen_item_gap));
            row.addView(value, vlp);
        }

        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.bottomMargin = dim(c, R.dimen.gen_item_gap);
        body.addView(row, lp);
        return value;
    }
    ...
    static TextView body(LinearLayout parent, CharSequence text) {
        return text(parent, text, R.dimen.gen_text_body, R.color.gen_on_surface, 0);
    }

    /** Secondary/explanatory text — the grey supporting line. */
    static TextView supporting(LinearLayout parent, CharSequence text) {
        return text(parent, text, R.dimen.gen_text_body, R.color.gen_on_surface_variant, 0);
    }
    ...
    static TextView caption(LinearLayout parent, CharSequence text) {
        return text(parent, text, R.dimen.gen_text_caption, R.color.gen_on_surface_faint, 0);
    }
    ...
    private static TextView text(LinearLayout parent, CharSequence text,
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.topMargin = topGapDp > 0 ? dp(c, topGapDp) : dim(c, R.dimen.gen_item_gap_tight);
    ...
    static TextView helpText(LinearLayout parent, CharSequence text) {
        ...
        ((LinearLayout.LayoutParams) view.getLayoutParams()).topMargin =
            dim(parent.getContext(), R.dimen.gen_item_gap);
        return view;
    }
    ...
    static View divider(LinearLayout parent) {
        ...
        line.setBackgroundColor(color(c, R.color.gen_outline_variant));
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, Math.max(1, dp(c, 1)));
        lp.topMargin = dim(c, R.dimen.gen_item_gap);
    ...
    static MaterialButton button(LinearLayout parent, int kind, int iconRes,
        ...
        b.setInsetTop(0);
        b.setInsetBottom(0);
        b.setMinHeight(dim(c, R.dimen.gen_button_height));
        b.setMinWidth(0);
        b.setMinimumWidth(0);
        ...
        if (iconRes != 0) {
            ...
            b.setIconSize(dim(c, R.dimen.gen_icon));
        ...
        switch (kind) {
            case BTN_PRIMARY:
                b.setBackgroundTintList(tint(c, R.color.gen_primary, R.color.gen_container_disabled));
                b.setTextColor(tint(c, R.color.gen_on_primary, R.color.gen_on_surface_disabled));
                b.setIconTint(tint(c, R.color.gen_on_primary, R.color.gen_on_surface_disabled));
                b.setRippleColor(tint(c, R.color.gen_ripple_light));
                break;
            case BTN_OUTLINE:
                b.setBackgroundTintList(tint(c, android.R.color.transparent));
                b.setStrokeWidth(Math.max(1, dp(c, 1)));
                b.setStrokeColor(tint(c, R.color.gen_outline, R.color.gen_outline_variant));
                b.setTextColor(tint(c, R.color.gen_on_surface, R.color.gen_on_surface_disabled));
                b.setIconTint(tint(c, R.color.gen_primary, R.color.gen_on_surface_disabled));
                b.setRippleColor(tint(c, R.color.gen_ripple_primary));
                break;
            case BTN_DANGER:
                b.setBackgroundTintList(tint(c, android.R.color.transparent));
                b.setStrokeWidth(Math.max(1, dp(c, 1)));
                b.setStrokeColor(tint(c, R.color.gen_tertiary_container, R.color.gen_outline_variant));
                b.setTextColor(tint(c, R.color.gen_tertiary, R.color.gen_on_surface_disabled));
                b.setIconTint(tint(c, R.color.gen_tertiary, R.color.gen_on_surface_disabled));
                b.setRippleColor(tint(c, R.color.gen_ripple_light));
                break;
            case BTN_TONAL:
            default:
                b.setBackgroundTintList(tint(c, R.color.gen_surface_container_high, R.color.gen_container_disabled));
                b.setTextColor(tint(c, R.color.gen_on_surface, R.color.gen_on_surface_disabled));
                b.setIconTint(tint(c, R.color.gen_primary, R.color.gen_on_surface_disabled));
                b.setRippleColor(tint(c, R.color.gen_ripple_light));
                break;
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.topMargin = dim(c, R.dimen.gen_item_gap_tight);
        parent.addView(b, lp);
        return b;
    }
    ...
    static void share(MaterialButton button, boolean firstInRow) {
        ...
        lp.topMargin = 0;
        if (!firstInRow) {
            lp.setMarginStart(dim(c, R.dimen.gen_item_gap_tight));
        }
        button.setLayoutParams(lp);
    }
    ...
    static MaterialButtonToggleGroup segmented(LinearLayout parent, CharSequence[] labels,
        ...
        for (int i = 0; i < labels.length; i++) {
            ...
            b.setStateListAnimator(null);
            b.setStrokeWidth(Math.max(1, dp(c, 1)));
            b.setStrokeColor(checkedTint(c, R.color.gen_primary, R.color.gen_outline));
            b.setBackgroundTintList(checkedTint(c, R.color.gen_primary, android.R.color.transparent));
            b.setTextColor(checkedTint(c, R.color.gen_on_primary, R.color.gen_on_surface_variant));
            b.setRippleColor(tint(c, R.color.gen_ripple_primary));
    ...
    static MaterialSwitch switchRow(LinearLayout parent, CharSequence title, CharSequence description) {
        ...
        TextView titleView = new TextView(c);
        titleView.setText(title);
        titleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_body));
        titleView.setTextColor(color(c, R.color.gen_on_surface));
        titleView.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        descView.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_caption));
        descView.setTextColor(color(c, R.color.gen_on_surface_faint));
        ...
        LinearLayout.LayoutParams slp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        slp.setMarginStart(dim(c, R.dimen.gen_item_gap));
    ...
    static Row listRow(LinearLayout parent, int iconRes, CharSequence title,
        ...
        row.setGravity(Gravity.CENTER_VERTICAL);
        row.setBaselineAligned(false);
        int padH = dim(c, R.dimen.gen_item_gap);
        int padV = dp(c, 14);
        row.setPadding(padH, padV, padH, padV);

        GradientDrawable bg = new GradientDrawable();
        bg.setShape(GradientDrawable.RECTANGLE);
        bg.setCornerRadius(dim(c, R.dimen.gen_radius_row));
        bg.setColor(color(c, R.color.gen_surface_container_high));
        ...
        if (iconRes != 0) {
            ...
            int s = dim(c, R.dimen.gen_icon);
            LinearLayout.LayoutParams ilp = new LinearLayout.LayoutParams(s, s);
            ilp.setMarginEnd(dim(c, R.dimen.gen_item_gap));
            row.addView(icon, ilp);
        }
        ...
        supportingView.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_caption));
        supportingView.setTextColor(color(c, R.color.gen_on_surface_variant));
        ...
        if (onClick != null) {
            ...
            chevron.setImageDrawable(ContextCompat.getDrawable(c, R.drawable.ic_gen_chevron));
            chevron.setImageTintList(tint(c, R.color.gen_on_surface_faint));
            int s = dp(c, 16);
            LinearLayout.LayoutParams clp = new LinearLayout.LayoutParams(s, s);
            clp.setMarginStart(dim(c, R.dimen.gen_item_gap_tight));
    ...
    static TextView chip(LinearLayout parent, int iconRes, CharSequence label, int textColorRes,
        ...
        chip.setText(label);
        chip.setTextSize(TypedValue.COMPLEX_UNIT_PX, dim(c, R.dimen.gen_text_caption));
